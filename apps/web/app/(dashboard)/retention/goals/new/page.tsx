...
export default function RetentionGoalsNewPage() {
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <Card className="saudi-card overflow-hidden">
        <CardHeader className="bg-gradient-to-br from-amber-50 via-white to-emerald-50/40 pb-2 text-center">
          ...
          <CardTitle className="text-xl font-bold tracking-tight">Retention Goals — New</CardTitle>
          <CardDescription>Create a new goals in your company.</CardDescription>
        </CardHeader>
